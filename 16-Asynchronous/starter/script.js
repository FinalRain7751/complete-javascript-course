...
//     // Get neighbouring countries (2)
//     const neighbours = data.borders;

//     if (!neighbours) return;

//     // AJAX call neighbouring countries
...
// const getCountryAndNeighbours = function (country) {
//   fetch(`https://restcountries.com/v3.1/name/${country}?fullText=false`)
//     .then(response => {
...
//     .then(response => response.json())
//     .then(data => {
//       for (let nation of data) {
//         renderCountry(nation, 'neighbour');
//       }
//     })
//     .catch(err => {
//       console.error(`${err}🌋🌋🌋`);
...
// getCountryAndNeighbours('dsffsssdd');
