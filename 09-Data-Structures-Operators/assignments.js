...
// const booksArrays = getBooksAsArrays();
// const [, [[, title]]] = booksArrays;
// console.log(title);
...
// [, { filmAdaptation: hasFilmAdaptation = false }] = books;
...
// let cyberiad;
// [, second] = books;
// cyberiad = { ...second, filmAdaptation: (hasFilmAdaptation = false) };
...
// function list(title, ...list_items) {
//   console.log(title);
//   for (let i = 0; i < list_items.length; i++) {
//     console.log(`${i + 1}) ${list_items[i]}`);
//   }
// }
...
// for (let book of books) {
//   book.otherLanguagesTitle.spanish && book.otherLanguagesTitle.korean && console.log(`${book.title} by ${book.author} has title in Spanish and Korean.`);
// }
...
// for (let book of books) {
//   (book.otherLanguagesTitle.spanish || book.otherLanguagesTitle.portuguese) && console.log(`${book.title} by ${book.author} has title in Spanish or Portuguese but not in both.`);
// }
